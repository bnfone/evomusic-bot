...
try {
  ...
  config = {
    ...
    PIPED_API_URL: process.env.PIPED_API_URL || "",
    PIPED_FALLBACK: process.env.PIPED_FALLBACK === "true",
    USE_METADATA_EXTRACTION: process.env.USE_METADATA_EXTRACTION === "true",
    LOG_TERMINAL: process.env.LOG_TERMINAL === "true",
    LOG_COMMANDS: process.env.LOG_COMMANDS === "true"
  };
}
