...
export const youtubeURLPattern = /^(https?:\/\/)?(www\.)?(youtube\.com|youtu\.?be)\/.+$/;
export const spotifyPattern = /^(spotify:|https:\/\/[a-z]+\.spotify\.com\/)/;
export const appleMusicPattern = /^https?:\/\/(music\.apple\.com)\/.+$/;
